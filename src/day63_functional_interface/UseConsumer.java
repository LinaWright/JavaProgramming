...
public class UseConsumer {
    public static void main(String[] args) {
        ...
        printToN.accept(50);//accept() is the abstract method defined in the Consumer interface (use control click on Consumer)
        System.out.println();

        List<String>list = new ArrayList<>(Arrays.asList("Hello","Summer","Pool"));
