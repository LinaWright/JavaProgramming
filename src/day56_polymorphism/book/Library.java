...
//        book2.fun = true; EBook reference does not have access to the fun variable
        ((JavaTextBook)book2).fun = true; //downCasting the reference from the parent EBook to the child reference of JavaTextBook anf that allows us to access the fun variable
        book2.read();
        book2.open();
        book2.download();
