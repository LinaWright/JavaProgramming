...
public class HomeWork4Army {
    /*
    Declare and assign these variables: Citizenship(boolean), resident (boolean), and has high school diploma (boolean), and age(int).
    ...
    public static void main(String[] args) {
        boolean Citizenship = false, resident = true, hasHighSchoolDiploma=true;
        int age=36;
