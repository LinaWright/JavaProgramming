...
public class StreamMethods2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        //filter() allow us to maintain ony certain elements based on the lambda expression
        ...
        System.out.println();
        list3.stream().filter( p -> p % 2 == 0).forEach(System.out::println); //preferred way to use the print statement
