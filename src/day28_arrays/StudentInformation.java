...
public class StudentInformation {
    ...
    public static void main(String[] args) {
        ...
        String[]question = {"Enter your id","Enter you first name","Enter your last name","What is your batch number"};
        for(int i = 0; i < 4; i++){
            System.out.println(question[i]);//reading each element of the questions array
